...
class EditPerfil : AppCompatActivity() {
    ...
    private fun setup2() {
        ...
        var Buscar = findViewById<Button>(R.id.btnbuscarcorreo) as Button
        var Correo2 = findViewById<View>(R.id.txtcorreobuscar) as TextView
        ...
        var correo3 = Correo2.text.toString()
        db.collection("Persona").document(correo3).get().addOnSuccessListener {
        ...
        Guardar.setOnClickListener {
            var correo3 = Correo2.text.toString()
            db.collection("Persona").document(correo3).set(
                hashMapOf(
            ...
            val i = Intent(this, Interfazadmin::class.java)
            startActivity(i)
        }
    }
